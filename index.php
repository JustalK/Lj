...
<body>
	...
	<div id="CONTENT">
		...
		<div id="FRAME1" data-src="./imgs/FRAME1.png" class="frame">
		...
		<div id="FRAME2" data-src="./imgs/FRAME2.png" class="frame frame-informations">
			...
			<div class="areas area-40">
				<div class="blocs bloc-informations">
					...
					<div class="blocs-inside background-white ">
						...
						<div class="blocs-inside-informations-page montserratlight"><span>1 / 2</span></div>
		...
		<div id="FRAME3" data-src="./imgs/FRAME1.png" class="frame">
			<div class="blackout-effect"></div>
			<div class="line-vertical line-white-up background-white"></div>
			<div class="line-vertical line-white-down background-white"></div>
	...
	<!-- FRAMEWORK -->
	<script type="text/javascript" src="./framework/modernizr.js"></script>
